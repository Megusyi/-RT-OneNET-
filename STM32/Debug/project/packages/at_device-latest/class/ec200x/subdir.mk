...
C_SRCS += \
../project/packages/at_device-latest/class/ec200x/at_device_ec200x.c \
../project/packages/at_device-latest/class/ec200x/at_socket_ec200x.c 

OBJS += \
./project/packages/at_device-latest/class/ec200x/at_device_ec200x.o \
./project/packages/at_device-latest/class/ec200x/at_socket_ec200x.o 

C_DEPS += \
./project/packages/at_device-latest/class/ec200x/at_device_ec200x.d \
./project/packages/at_device-latest/class/ec200x/at_socket_ec200x.d 


# Each subdirectory must supply rules for building sources it contributes
project/packages/at_device-latest/class/ec200x/%.o: ../project/packages/at_device-latest/class/ec200x/%.c
